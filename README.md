[![GoDoc](https://godoc.org/github.com/golang/gddo?status.svg)](https://godoc.org/github.com/romarq/go-tezos-tezaria)
# A Tezos Go Library
...
Get goTezos 
```
go get github.com/romarq/go-tezos-tezaria
```
...
import (
	"fmt"
	goTezos "github.com/romarq/go-tezos-tezaria"
)
